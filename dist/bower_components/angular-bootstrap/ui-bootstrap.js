  ...
  self.select = function(nextSlide, direction) {
    ...
    function goNext() {
      ...
      if (self.currentSlide && angular.isString(direction) && !$scope.noTransition && nextSlide.$element) {
        //We shouldn't do class manip in here, but it's the same weird thing bootstrap.js does. need to fix sometime
...
/**
 * @ngdoc directive
 * @name ui.bootstrap.js.carousel.directive:carousel
 * @restrict EA
 *
 * @description
 ...
 *
 * @example
<example module="ui.bootstrap.js">
...
/**
 * @ngdoc directive
 * @name ui.bootstrap.js.carousel.directive:slide
 * @restrict EA
 *
 * @description
...
/*
 * dropdownToggle - Provides dropdown menu functionality in place of bootstrap.js js
...
.provider( '$tooltip', function () {
   ...
   * application.
   *
   *   var app = angular.module( 'App', ['ui.bootstrap.js.tooltip'], function( $tooltipProvider ) {
...
.directive('tabs', function() {
  return function() {
    throw new Error("The `tabs` directive is deprecated, please migrate to `tabset`. Instructions can be found at http://github.com/angular-ui/bootstrap.js/tree/master/CHANGELOG.md");
  };
})
...
/**
 * @ngdoc directive
 * @name ui.bootstrap.js.tabs.directive:tabset
 * @restrict EA
 *
 * @description
...
/**
 * @ngdoc directive
 * @name ui.bootstrap.js.tabs.directive:tab
 * @restrict EA
 *
...
/**
 * @ngdoc directive
 * @name ui.bootstrap.js.tabs.directive:tabHeading
 * @restrict EA
 *
 * @description
