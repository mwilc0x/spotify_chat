...
window.onload = function () { // wait for load in a dumb way because B-0
  ...
  function parseUrl() {
    ...
    .error(function(err) {
      showError('Error fetching bootstrap.js config file', err)
    })
  }
  ...
  // Returns an Array of @import'd filenames from 'bootstrap.js.less' in the order
  ...
  if (!window.URL && navigator.userAgent.toLowerCase().indexOf('safari') != -1) {
    showCallout("Looks like you're using safari, which sadly doesn't have the best support\
                 ...
                 to <code>\"bootstrap.js.zip\"</code> and you should be good to go!")
