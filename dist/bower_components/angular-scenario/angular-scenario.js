 ...
 * @description
 *
 * Use this directive to auto-bootstrap.js an application. Only
 * one ngApp directive can be used per HTML document. The directive
 * designates the root of the application and is typically placed
 * at the root of the page.
 *
 * The first ngApp found in the document will be auto-bootstrapped. To use multiple applications in an
 * HTML document you must manually bootstrap.js them using {@link angular.bootstrap}.
 ...
 *
 * `ngApp` is the easiest way to bootstrap.js an application.
 *
 <doc:example>
   <doc:source>
    I can add: 1 + 2 =  {{ 1+2 }}
 ...
 *
 * Note that ngScenario-based end-to-end tests cannot use this function to bootstrap.js manually.
 ...
 *  before the template enters execution mode during bootstrap.js.
 *
 * @element ANY
 ...
 * Must be first in the compilation/bootstrap.js list.
 */
